...
export default function ResourceCalendar() {
  ...
  const router = useRouter();
    ...
    <video key={currentVideoIndex} style={styles.video} autoPlay loop muted>
    ...
    <div style={styles.left}>
        ...
        <div style={styles.nextVideoButton}>
            <button style={styles.button} onClick={() => setCurrentVideoIndex((prev) => (prev + 1) % videoSources.length)}>
                Change Background
            </button>
        </div>
        <DayPilotNavigator
